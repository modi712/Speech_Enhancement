...
class BasicDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        #spectrogram1a = 10*spectrogram1a
        ...
        #spectrogram1a = spectrogram1a/np.amax(spectrogram1a)
        ...
        spectrogram1a = spectrogram1a.reshape(1,1025,l)
        spectrogram2a = spectrogram2a.reshape(1,1025,l)
